...
export interface InputAuthProps<T> extends InputBaseProps {
  iconStart?: string;
  iconEnd?: string;
  labelText?: string;
...
function InputAuth<T>({ id, type, iconStart, labelText, iconEnd, control, nameInput, rules, error, messageErr, ...rest }: InputAuthProps<T>) {

...
export function formatDuration(minutes: number) {
  ...
  if (hours == 0 && minutesMod60 > 1) {
    return i18n.t('translation:0hour_and_minutes', { hours, minutes: minutesMod60 });
  }
  if (hours == 0 && minutesMod60 == 1) {
    return i18n.t('translation:0hour_and_minute', { hours, minutes: minutesMod60 });
  }
}

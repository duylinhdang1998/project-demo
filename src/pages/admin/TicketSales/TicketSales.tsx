...
export default function TicketSales() {
  ...
  const columnsTicket: ColumnsType<Ticket> = [
    ...
    { key: 'firstName', dataIndex: 'firstName', width: 90, title: () => <div>{t('firstName')}</div> },
    {
      key: 'trip',
      dataIndex: 'trip',
      width: 200,
    ...
    { key: 'orderId', dataIndex: 'orderId', title: () => <div>{t('order_id')}</div>, width: 80, align: 'center', sorter: true },
    { key: 'createdBy', dataIndex: 'createdBy', title: () => <div>{t('createdBy')}</div>, width: 120, align: 'center' },
  ];

...
export interface EmailEditorProps {
  errors: FieldErrors<BatchMailFormValues>;
  messages: Record<string, string>;
  control: Control<BatchMailFormValues, any>;
  description: BatchMailFormValues['description'];
  onChange: (description: BatchMailFormValues['description']) => void;
  label: Extract<keyof BatchMailFormValues, 'description'>;
  required: boolean;
}

export const EmailEditor = ({ control, description, errors, messages, onChange, label, required }: EmailEditorProps) => {

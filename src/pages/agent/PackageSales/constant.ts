...
export const fields1: Field[] = [
  { id: uuidv4(), required: true, label: 'departures_point', type: 'departurePoint' },
  { id: uuidv4(), required: true, label: 'arrival_points', type: 'arrivalPoint' },
  { id: uuidv4(), required: true, label: 'departure_time', type: 'datetime' },
];
...
export const fields2: Field[] = [
  ...
  { id: uuidv4(), required: true, label: 'sender_mobile', type: 'text' },
];
export const fields3: Field[] = [
  ...
  { id: uuidv4(), required: true, label: 'recipent_mobile', type: 'text' },
];
